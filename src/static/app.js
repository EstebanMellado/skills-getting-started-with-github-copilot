document.addEventListener("DOMContentLoaded", () => {
              ...
              .map(
                (participant) => `
                  <div class="participant-item">
                    ...
                    <button type="button" class="remove-participant-btn" data-email="${participant}" aria-label="Remove ${participant}">
                      ✕
                    </button>
                  </div>
                `
  ...
  activitiesList.addEventListener("click", (event) => {
    ...
    const activityName = removeButton.closest(".activity-card")?.querySelector("h4")?.textContent;
